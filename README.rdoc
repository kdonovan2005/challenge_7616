...
2. '\[' open bracket as a literal
3. '.+' match one or more of any characters
4. '\]' close bracket as a literal
5. '$' match end of string
...
A couple of films' budgets are give in British pounds. The numerical value is taken one to one and is not being converted via any exchange rate from pounds to US dollars. This is possibly skewing the average budget because of the difference in conversion rate.
