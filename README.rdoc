...
A couple of films' budgets are give in British pounds. The numerical value is taken one to one and is not being converted via any exchange rate from pounds to US dollars. This is skewing the average budget because of the difference in conversion rate.
